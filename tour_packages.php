	...
	<head>
		...
		<!-- Site Title -->
		<title>Uratengamaye Kivu | Tour Packages</title>
		...
		<body>
			<?php require_once("inc/header.php");?>
					<!-- start banner Area -->
			<section class="banner-area relative" id="home" style="background: url(img/test/25.jpg) center;
				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="tour_packages"> Tour packages</a></p>
						</div>											
					</div>
				</div>
			</section>
            ...
            <div class="block personal fl">
                ...
                <!-- PT-FOOTER -->
                <div class="pt-footer">
                    <p><a href="" class="btn btn-block">Book</a></p>
                </div>
                <!-- /PT-FOOTER -->
            </div>
            <!-- /PERSONAL -->
