...
<body>
	...
	<?php require_once("inc/header.php")?>
		...
		<section class="banner-area relative" id="home" style="background: url(img/test/45.jpg) center;background-size: cover;">	
				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="cars_for_sale"> Cars sale</a></p>
						</div>											
					</div>
				</div>
		</section>
			...
			<div class="row d-flex justify-content-center">
						<div class="menu-content pb- col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">All cars for sale </h1>
							...
							<div class="col-lg-4 col-md-6">
								<div class="single-feature1">
									...
									<div class="feature-bottom">
										<h5>TXL<a style="text-decoration: none;color: grey;" data-toggle="collapse" href="#collapse3" role="button" aria-expanded="false" aria-controls="collapseExample">
										    <i class="icofont-plus-circle"></i>
										  </a></h5>
					...
					<div class="row">
							<div class="col-lg-4 col-md-6">
								<div class="single-feature1">
									...
									<div class="feature-bottom">
										<h5>HONDA CRV<a style="text-decoration: none;color: grey;" data-toggle="collapse" href="#collapse3" role="button" aria-expanded="false" aria-controls="collapseExample">
										    <i class="icofont-plus-circle"></i>
										  </a></h5>
							...
							<div class="col-lg-4 col-md-6">
								<div class="single-feature1">
									...
									<div class="feature-bottom">
										<h5>RAV 2007 BLUE<a style="text-decoration: none;color: grey;" data-toggle="collapse" href="#collapse3" role="button" aria-expanded="false" aria-controls="collapseExample">
										    <i class="icofont-plus-circle"></i>
										  </a></h5>
							...
							<div class="col-lg-4 col-md-6">
								<div class="single-feature1">
									<div class="feature-image">
									   <img src="uploads/RAV4_2004_SILVER/2.jpg" alt="RAV4_2004_SILVER">
										<div class="feature-overlay">
											<div class="display-table">
												<div class="display-tablecell">
												   <a  href="car_details"><i class="icofont-car"></i></a>
									...
									<div class="feature-bottom">
										<h5>RAV4 2004 SILVER<a style="text-decoration: none;color: grey;" data-toggle="collapse" href="#collapse3" role="button" aria-expanded="false" aria-controls="collapseExample">
										    <i class="icofont-plus-circle"></i>
										  </a></h5>
							...
							<div class="col-lg-4 col-md-6">
								<div class="single-feature1">
									...
									<div class="feature-bottom">
										<h5>RAV4 2006 KAKI<a style="text-decoration: none;color: grey;" data-toggle="collapse" href="#collapse3" role="button" aria-expanded="false" aria-controls="collapseExample">
										    <i class="icofont-plus-circle"></i>
										  </a></h5>
							...
							<div class="col-lg-4 col-md-6">
								<div class="single-feature1">
									<div class="feature-image">
									   <img src="uploads/rav4_dark_blue/4.jpg" alt="rav4_dark_blue">
										<div class="feature-overlay">
											<div class="display-table">
												<div class="display-tablecell">
												   <a  href="car_details"><i class="icofont-car"></i></a>
									...
									<div class="feature-bottom">
										<h5>RAV4 DARK BLUE<a style="text-decoration: none;color: grey;" data-toggle="collapse" href="#collapse3" role="button" aria-expanded="false" aria-controls="collapseExample">
										    <i class="icofont-plus-circle"></i>
										  </a></h5>
					...
					<div class="row">
							<div class="col-lg-4 col-md-6">
								<div class="single-feature1">
									...
									<div class="feature-bottom">
										<h5>COROLLA ALTIS<a style="text-decoration: none;color: grey;" data-toggle="collapse" href="#collapse3" role="button" aria-expanded="false" aria-controls="collapseExample">
										    <i class="icofont-plus-circle"></i>
										  </a></h5>
							...
							<div class="col-lg-4 col-md-6">
								<div class="single-feature1">
									...
									<div class="feature-bottom">
										<h5>COROLLA VERSO 2002 VOITURE<a style="text-decoration: none;color: grey;" data-toggle="collapse" href="#collapse3" role="button" aria-expanded="false" aria-controls="collapseExample">
										    <i class="icofont-plus-circle"></i>
										  </a></h5>
